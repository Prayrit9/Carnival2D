-- Token ProcessID = "8RPiT1KlfJA0CCV1-Ize3Uhux6u7_zusbijWabJqink"
...
--
if not Balances then Balances = { [ao.id] = tostring(bint(1000000000)) } end

if Name ~= 'FunCoin' then Name = 'FunCoin' end

if Ticker ~= 'FC' then Ticker = 'FC' end
